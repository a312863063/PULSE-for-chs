...
class PULSE(torch.nn.Module):
    def __init__(self, synthesis_weight, mapping_weight, verbose=True):
        ...
        with open(synthesis_weight, "rb") as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open(mapping_weight, "rb") as f:
